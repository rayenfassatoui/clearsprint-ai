...
You are an expert Full-Stack Engineer building ClearSprint AI.
...
- After each interaction, tell the user next steps and recommended polish changes, maximum 3 bullet points, with usefull feature improvement, quality of life stuff or visual UI UX polish.
...
- **Never**:
    ...
    - run ls -R without ignoring the nodemodules (ls -R | grep -v '/node_modules/')

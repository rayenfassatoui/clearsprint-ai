          ...
          <div className='grid gap-16 lg:grid-cols-2 lg:gap-20'>
            <div className='space-y-10'>
              <div className='space-y-8'>
                <h1 className='text-balance text-5xl font-semibold leading-tight text-foreground sm:text-5xl lg:text-6xl tracking-tight'>
                  Orchestrez chaque sprint avec un partenaire IA conçu pour les
                  équipes collaboratives.
                </h1>
                <p className='text-pretty text-base text-muted-foreground sm:text-lg leading-relaxed'>
                  Centralisez vos projets, automatisez la priorisation et gardez
                  une longueur d'avance sur les risques grâce à des analyses
                  prédictives qui maintiennent votre équipe alignée, productive
                  et à l'heure.
                </p>
              </div>
              ...
              <div className='flex flex-col gap-4 sm:flex-row sm:items-center'>
                <Button
                  asChild
                  className='bg-primary text-primary-foreground shadow-[0_20px_45px_-18px_rgba(16,185,129,0.7)] dark:shadow-[0_20px_45px_-18px_rgba(16,185,129,0.4)] transition hover:bg-primary/90 hover:scale-105 text-sm font-medium px-6 py-2.5'
                >
                ...
                <Button
                  asChild
                  variant='outline'
                  className='border-primary/30 bg-transparent text-primary hover:bg-primary/10 hover:text-primary hover:scale-105 text-sm font-medium px-6 py-2.5'
                >
            ...
            <div className='grid gap-6 sm:grid-cols-1 content-start'>
              <div className='rounded-3xl border border-primary/20 bg-card dark:bg-card/50 px-8 py-8 text-card-foreground shadow-sm backdrop-blur-sm hover:border-primary/30 hover:shadow-md hover:scale-[1.02] transition-all duration-300'>
                ...
                <p className='mt-3 text-xs text-muted-foreground leading-relaxed'>
                  Les mises à jour sont diffusées instantanément sur chaque
                  appareil.
                </p>
              </div>
              <div className='rounded-3xl border border-primary/20 bg-card dark:bg-card/50 px-8 py-8 text-card-foreground shadow-sm backdrop-blur-sm hover:border-primary/30 hover:shadow-md hover:scale-[1.02] transition-all duration-300'>
                ...
                <p className='mt-4 text-xl font-semibold leading-snug text-foreground'>
                  Zéro échéance manquée
                </p>
                <p className='mt-3 text-xs text-muted-foreground leading-relaxed'>
                  Des rappels personnalisés anticipent les risques avant qu'ils
                  ne surviennent.
                </p>
              </div>
              <div className='rounded-3xl border border-primary/20 bg-card dark:bg-card/50 px-8 py-8 text-card-foreground shadow-sm backdrop-blur-sm hover:border-primary/30 hover:shadow-md hover:scale-[1.02] transition-all duration-300'>
                ...
                <p className='mt-3 text-xs text-muted-foreground leading-relaxed'>
                  Des tableaux de bord révèlent le débit, la charge et les
                  goulets d'étranglement à venir.
                </p>
              </div>
            </div>
          </div>
